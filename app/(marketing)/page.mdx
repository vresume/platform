import { SparkleIcon } from "~/components/marketing/sparkle-icon";

export { Layout as default } from "~/components/marketing/layout";

---

![](~/images/0x-release.png)
...
## Funnel to Meridian {{  date: '2023-09-12T00:00Z' }}
